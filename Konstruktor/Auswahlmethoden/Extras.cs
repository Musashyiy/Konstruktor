...
namespace Konstruktor.Methoden
{
    public class Extra
    {
        public static void ExtrasSelection(MyPc mypc)
        {
            ...
            Console.WriteLine("Wollen sie Extras hinzufügen? Ja(y) oder Nein(n)?");
            char.TryParse(Console.ReadLine(), out extrasyesno);
            Console.Clear();
            ...
            if (ready == false)
            {
                ...
                else if (extrasyesno == 'n')
                {
                    Console.WriteLine("Es werden keine Extras hinzugefügt.");
                    ready = true;
                }

                else
                {
                    Console.WriteLine("Ungültige Eingabe. Bitte erneut auswahlen.");
                }
